...
{
    public class DeadNoteDataBaseTable : IDateBaseQueryableDateTime<Note>, IDeadDataBaseByDateTimeTable<Note>
    {
        private readonly SQLiteConnection _dataBase;
        public DeadNoteDataBaseTable(SQLiteConnection sQLiteConnection)
        {
        ...
        public Note GetItem(int id)
        {
            ...
            string query = $"select * from {Name} where {idPropertyName} = ? and {deletedPropertyName} IS NOT NULL ";
        ...
        public IEnumerable<Note> GetByDate(DateTime dateTime)
        {
            ...
            string query = $"select * from {Name} where {appointmentDatePropertyName} >= ? and {appointmentDatePropertyName} < ? and {deletedPropertyName} IS NOT NULL";
